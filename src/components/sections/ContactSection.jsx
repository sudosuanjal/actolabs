  ...
  return (
    <div className="bg-black min-h-screen flex flex-col items-center justify-center p-4">
      ...
      <div className="w-full bg-black px-4 md:px-8 lg:px-12">
        {/* Combined Box */}
        <div className="bg-black h-11/12 px-4 md:px-8 lg:px-12 py-8 md:py-12 lg:py-16 rounded-3xl shadow-lg border-0 md:border border-white-800">
            ...
            <div className="w-full md:w-1/2 p-6 flex flex-col justify-between">
              <form onSubmit={onSubmit}>
                ...
                <input
                  ...
                  placeholder="Name"
                  required
                  className="w-full md:w-11/12 p-4 mb-4 bg-black text-white rounded-md"
                />
                ...
                <textarea
                  ...
                  placeholder="Message"
                  required
                  className="w-full md:w-11/12 p-5 mb-4 bg-black text-white rounded-md resize-none"
                ></textarea>
                <button
                  type="submit"
